...
export default function SimpleInfoSection({
  ...
  titleClassName = "text-primary text-[26px] sm:text-[30px] md:text-[40px] leading-tight font-[500] mb-4",
  descriptionClassName = "text-black text-[14px] sm:text-[15px] md:text-[16px] leading-relaxed opacity-90",
  maxWidth = "max-w-3xl"
