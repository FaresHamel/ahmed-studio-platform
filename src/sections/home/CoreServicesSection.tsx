...
export default function CoreServicesSection() {
  const renderServiceCard = (service: Service, index: number) => (
    <div className="border border-zinc-100 rounded-[20px] p-6 flex flex-col bg-white hover:shadow-xl transition-shadow duration-300 h-full">
  ...
  return (
    <div className="flex flex-col items-center my-[100px]">
      <div className="text-center mb-16">
        <h2 className="font-poppins text-primary text-[26px] sm:text-[32px] md:text-5xl font-bold mb-3 md:mb-4">
          Core Services
        </h2>

        <p className="font-poppins text-black text-[13px] sm:text-[15px] md:text-lg opacity-80 leading-relaxed">
      ...
      <CardGrid
        ...
        gap="large"
        containerClassName="w-full mb-16"
      />
