...
const COMPARISON_ROWS: ComparisonRow[] = [
  ...
  {
    feature: "Best International Practices Workflow",
    ahmed: true,
    others: false
  },
  { feature: "Home Video Digitization Equipment", ahmed: false, others: true },
  {
    feature: "Door to Door Free Pick Up & Delivery",
    ahmed: true,
    others: false
  },
  ...
  { feature: "Apple Devices App", ahmed: true, others: false },
  { feature: "Android Devices App", ahmed: true, others: false },
  { feature: "USB", ahmed: true, others: true }
];
...
export default function ComparisonTableSection() {
  return (
    <section className="max-w-[1170px] mx-auto px-4 mt-24">
      <SimpleInfoSection
        title=" Comparison"
        description=" Not All Digitization is Created Equal. When you're choosing who to
          trust with your only copies of irreplaceable moments, the details
          matter. Many bargain services outsource their labor or use
          automated machines that can eat your tapes. Here is how Ahmed Studio
          ...
          <div className="flex items-center justify-center gap-3 bg-[#FFDC99] rounded-xl p-2">
            <div>
              <Image
                ...
                alt="Detail magnification texture"
                width={50}
                height={50}
                objectFit="object-center"
              />
            </div>
