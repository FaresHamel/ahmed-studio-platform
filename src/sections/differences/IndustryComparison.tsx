...
export default function IndustryComparison() {
  ...
  const COMPARISON_ROWS: ComparisonRow[] = [
    { feature: "Sound quality", ahmed: true, others: false },
    { feature: "Video quality", ahmed: true, others: false },
    {
      feature: "signal stabilization",
      ahmed: true,
      others: false
    },
    {
    ...
    { feature: "data lost", ahmed: false, others: true },
    { feature: "approved by Institution", ahmed: true, others: false }
  ];
  ...
  return (
    <section className="w-full max-w-6xl mx-auto px-4 py-12 bg-white font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-8 items-stretch">
        ...
        <CompareCard imageSrc="/images/InderstryEquipment.png" />
        <CompareCard imageSrc="/images/homeEquipment.png" />
      </div>
