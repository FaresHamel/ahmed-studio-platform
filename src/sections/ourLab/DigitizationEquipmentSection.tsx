...
// قائمة بيانات الصور الثمانية للأجهزة الاحترافية كما تظهر في التصميم
...
export default function DigitizationEquipmentSection() {
  return (
    <section className="w-full bg-white overflow-visible flex flex-col items-center">
      {/* 1. الجزء العلوي: الخلفية الملونة #FFEDDE مع العناوين والنصوص */}
      ...
      {/* 2. الجزء السفلي: شبكة الصور المتداخلة مع الجزء العلوي (Overlapping Images) */}
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 w-full overflow-visible">
        {/* المارجن السالب -mt-16 يرفع الصف العلوي ليتراكب فوق الحافة البيضاء والخلفية الكريمية */}
        {/* تم تثبيت grid-cols-4 وتعديل الـ gap ليكون صغيراً في الجوال لتناسب الصور مساحة الشاشة أفقياً */}
